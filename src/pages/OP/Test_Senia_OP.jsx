...
export default function Test_Senia_OP() {
  ...
  return (
    <Card className="h-full w-full mt-2 bg-transparent shadow-none">
          ...
          <Collapse open={true}>
            <Card className="my-4 mx-auto w-full">
              <CardBody>
                ...
                <div
                  key={1}
                  className="rounded-2xl mx-auto  shadow-2xl cursor-pointer"
                >
                  ...
                  <canvas
                    className="output_canvas border-4 border-black "
                    ref={canvasRef}
                  />
                </div>
                <>
      ...
      <video className="input_video invisible w-3/4" ref={videoRef}></video>
    </Card>
  );
}
